  ...
  return (
    <div className="space-y-8 animate-fade-in" id="dashboard_view">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6" id="dashboard_details_grid">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100" id="card_isp_status">
          <h4 className="text-base font-semibold text-slate-800 mb-4">网络运营商线路分布 (ISP)</h4>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100" id="card_region_status">
          <h4 className="text-base font-semibold text-slate-800 mb-4">主要覆盖省份排行</h4>
              ...
              {topProvinces.map(([prov, count], index) => {
                ...
                return (
                  <div key={prov} className="flex items-center space-x-3">
                    <span className="w-6 h-6 flex items-center justify-center bg-indigo-50 text-indigo-700 rounded-full font-mono text-xs font-bold">
                      {index + 1}
                    </span>
